...
* **similarity_taxonomy_attributes**: The list of model attributes defining the relation between taxonomy value and the model. It is an array contantaing the model relation name as key and a taxonomy attribute name as the value (`category` => `category_name`).
